...
class App extends Component {
    ...
    fetchWeather = async ( event ) => {
        ...
        var options = 
        {
            hearders:{'X-Auth-Token':'799e2799319d75098895c73b8e2c7287'},
        ...
        // Ajout du titre et du contenu de chaque station d emetro
        
		var commonName = document.createElement("h2");
        commonName.textContent = json.titre;
        var contenuElt = document.createElement("p");
        contenuElt.textContent = json.contenu;
        jsonElt.appendChild(commonName);
        jsonElt.appendChild(contenuElt);
    })
